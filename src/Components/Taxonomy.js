    ...
    <div className="container mt-5">
      ...
      <div className="table-responsive">
        <table className="table table-bordered table-hover mt-4">
          ...
          <tbody>
            <tr>
              <td>Category 1: AI-Driven Personalization and User Experience</td>
            ...
            <tr>
              <td>Category 2: AI in Web Development and Automation</td>
            ...
            <tr>
              <td>Category 3: AI-Driven User Profiling and Adaptive Systems</td>
              <td>Paper 8,9,24</td>
            ...
            <tr>
              <td>Category 4: AI in Market Intelligence and Product Development</td>
            ...
            <tr>
              <td>Category 5: AI in User Interface (UI) Design and Adaptive Systems</td>
              <td>Paper 19,25</td>
            ...
            <tr>
              <td>Category 6: Ethical Considerations and Challenges in AI-Driven Personalization</td>
              <td>Paper 7,10</td>
